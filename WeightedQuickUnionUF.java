 ...
 *
 *  I am leaving this file as un-altered as possible. My only changes were to
 *  comment out the main, and to make union return a boolean. -Seth
 ******************************************************************************/
 ...
 *          // intelliJ is calling UF, QuickFindUF, and QuickUnionUF "project errors"
 *
...
public class WeightedQuickUnionUF {
     ...
     *         both {@code 0 <= p < n} and {@code 0 <= q < n}
     *
     * -> I added returns true/false for unioned or not
     */
    public boolean union(int p, int q) {
        ...
        count--;
        return true; // added to know if a union has been made for walls list
    }
